...
<div id="box">
  ...
  <table class="article">
    ...
    <tr>
      <td></td>
      <td>
        <input class="tombol-biru" type="button" value="Akun akan otomatis keluar setelah melakukan perubahan. Silahkan login kembali menggunakan data yang sudah diupdate">
      </td>
    </tr>
    <tr>
      <td></td>
